...
void handleRoot() {
  ...
  html += "<style>";
  html += "body { font-family: Arial, sans-serif; text-align: center; background-color: #f8f9fa; }";
  html += "h1 { color: #0d6efd; }";
  html += "h2 { color: #fd7e14; }";
  html += "button { padding: 10px 20px; font-size: 16px; margin: 10px; background-color: #ffc107; border: none; border-radius: 5px; color: #f8f9fa; }";
